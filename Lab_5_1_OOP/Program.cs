...
namespace Lab_5_1_OOP
{
    class Course
    {
        ...
        public void AverageAmountStudents(List<PracticeTask> tasks)
        {
            int i = 0;
            double p = 0;
        ...
        public void MaxAmountStudents(List<PracticeTask> tasks)
        {
        ...
        public void SearchWithSubstring(List<PracticeTask> tasks)
        {
